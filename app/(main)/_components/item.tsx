...
export const Item = ({
    ...
    const ChevronIcon = expaned ? ChevronDown : ChevronRight
    ...
    return (
        ...
        >
            {!!id && (
                <div
                    role='button'
                    className="h-full rounded-sm hover:bg-neutral-300 dark:hover:bg-neutral-600 absolute mr-1"
                    onClick={() => { }}
                >
                    <ChevronIcon
                        onClick={onExpand}
                        className={cn("w-4 h-4 mr-2", expaned && 'text-primary')} />
                </div>
            )}
            {documentIcon ? (
